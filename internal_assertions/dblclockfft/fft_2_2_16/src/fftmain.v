...
//			only having 17 bits for each of the real and imaginary
//			components, leading to 34 bits total.
...
//		line:
//
//		% ./fftgen -1 -f 2 -k 2 -n 16
//
//	This core will use hardware accelerated multiplies (DSPs)
//	for -1 of the 1 stages
//
...
module fftmain(i_clk, i_reset, i_ce,
	...
	localparam	IWIDTH=16, OWIDTH=17; // LGWIDTH=1;
	//
