...
close $fp
set vhdl_files [split [string trim ${file_data}] "\n"]
ghdl --std=08 --work=neorv32 -gHART_ID=0 -gVENDOR_ID=00000000000000000000000000000000 -gBOOT_ADDR=00000000000000000000000000000000 -gDEBUG_PARK_ADDR=00000000000000000000000000000000 -gDEBUG_EXC_ADDR=00000000000000000000000000000000 -gCPU_TRACE_EN=true {*}$vhdl_files -e ${design}
