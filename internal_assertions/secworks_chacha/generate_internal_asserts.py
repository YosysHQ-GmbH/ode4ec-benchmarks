...
RUN_DIR = Path("run")
GATE_NETLIST = RUN_DIR / "gate_out.il"
GOLD_NETLIST = RUN_DIR / "gold_out.il"
...
def main() -> None:
    ...
    out_ports_a_vh = OUT_FOLDER / f"ports_a_{args.backend}.vh"
    out_ports_b_vh = OUT_FOLDER / f"ports_b_{args.backend}.vh"
    out_asserts_vh = OUT_FOLDER / f"asserts_{args.backend}.vh"
